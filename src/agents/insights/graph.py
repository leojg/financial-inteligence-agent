...
from agents.insights.nodes import load_context, compute_aggregations, make_generate_insights_node, persist_results
...
def make_graph(
    ...
    graph.add_node("generate_insights", make_generate_insights_node(config))
